class Admin::HospitalsController < Admin::AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @hospital.save
        format.html { redirect_to admin_hospital_path(@hospital), notice: 'Hospital was successfully created.' }
  ...
  def update
    respond_to do |format|
      ...
      if @hospital.update(hospital_attr)
        format.html { redirect_to admin_hospital_path(@hospital), notice: 'Hospital was successfully updated.' }
